...
#         'cifar100': {'train': True, 'download': False},
#         'svhn': {'split': 'train', 'download': False}
#         }
#
# test_kwargs = {
#         'cifar10': {'train': False, 'download': False},
#         'cifar100': {'train': False, 'download': False},
#         'svhn': {'split': 'test', 'download': False}
#         }
#
...
class Caltech256(dsets.Caltech256):
    num_classes = 256
    def __init__(self, num_labels, num_iters, batch_size, return_unlabel=True, save_path=None, **kwargs):
        super(Caltech256, self).__init__(**kwargs)
        labels_per_class = num_labels // self.num_classes
        self.return_unlabel = return_unlabel
...
def dataloader1(dset, path, bs, num_workers, num_labels, num_iters, return_unlabel=True, save_path=None):
    assert dset in ["mnist", "caltech256"]
